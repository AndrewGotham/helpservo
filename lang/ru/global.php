...
return [
    ...
    'send_password'                        => 'Получить ссылку на смену пароля',
    'save'                                 => 'Сохранить',
    'search'                               => 'Посик',
    ...
    'datatables'                           => [
        ...
        'print'         => 'Печать',
        'colvis'        => 'Видимость',
        'delete'        => 'Удалить отмеченное',
        'zero_selected' => 'Нет отмеченного',
    ],
    'action'                               => 'Действие',
    'action_id'                            => '№ действия',
    'action_model'                         => 'Action model',
    'address'                              => 'Адрес',
    'administrator_can_create_other_users' => 'Администратор (может создавать пользователей)',
