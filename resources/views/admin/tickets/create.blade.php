    ...
    <div class="card-body">
        <form action="{{ route("admin.tickets.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('topic') ? 'has-error' : '' }}">
                <label for="topic">{{ trans('cruds.ticket.fields.topic') }}*</label>
                <input type="text" id="topic" name="topic" class="form-control" value="{{ old('topic', isset($ticket) ? $ticket->topic : '') }}" required>
                @if($errors->has('topic'))
                ...
                <p class="helper-block">
                    {{ trans('cruds.ticket.fields.topic_helper') }}
                </p>
            </div>
